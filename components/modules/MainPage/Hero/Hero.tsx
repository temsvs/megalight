...
import img1 from '@/public/img/orange-t.png'
import img2 from '@/public/img/clothes/cloth-t-shirts-1.png'
import img3 from '@/public/img/accessories/accessories-bags-3.png'
...
const Hero = () => {
  ...
  const slides = [
    {
      id: 1,
      title: `${translations[lang].main_page.tShirt} «Feron» ${translations[lang].main_page.orange}`,
      image: img1,
    },
    {
      id: 2,
      title: `${translations[lang].main_page.tShirt} «Ecola» ${translations[lang].main_page.black}`,
      image: img2,
    },
    {
      id: 3,
      title: `${translations[lang].main_page.backpack} «Ecola» ${translations[lang].main_page.fabric}`,
      image: img3,
    },
  ]
